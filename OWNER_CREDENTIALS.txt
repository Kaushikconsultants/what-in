...
**Domain**: https://what-inn.tikal.in
...
- **Login URL**: https://what-inn.tikal.in/owner/login
...
- **Login URL**: https://what-inn.tikal.in/login
...
4. Add the CNAME record in your DNS provider (Cloudflare, GoDaddy, etc.) pointing what-inn.tikal.in to Railway's CNAME target.
