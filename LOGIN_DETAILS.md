...
**Domain**: [https://what-inn.tikal.in](https://what-inn.tikal.in)  
**GitHub Repository**: [https://github.com/Kaushikconsultants/what-in.git](https://github.com/Kaushikconsultants/what-in.git)
...
- **Login URL**: [https://what-inn.tikal.in/owner/login](https://what-inn.tikal.in/owner/login)
- **Local URL**: [http://localhost:3000/owner/login](http://localhost:3000/owner/login)
...
- **Login URL**: [https://what-inn.tikal.in/login](https://what-inn.tikal.in/login)
- **Local URL**: [http://localhost:3000/login](http://localhost:3000/login)
- **Admin Email**: `admin@what-inn.tikal.in`
...
- **Callback URL**: `https://what-inn.tikal.in/api/whatsapp/webhook`
...
*(For dedicated client webhooks, use: `https://what-inn.tikal.in/api/whatsapp/webhook/<clientId>`)*

---

## 4. 🗄️ PostgreSQL Database Configuration (Railway)
...
NEXTAUTH_URL="https://what-inn.tikal.in"
...
## 6. 🛠️ Custom Domain Setup on Railway
1. Open your project on [Railway](https://railway.app).
2. Click your web service -> **Settings** -> **Networking** -> **Custom Domain**.
3. Add `what-inn.tikal.in`.
4. Add the CNAME record in your DNS provider (e.g., Cloudflare, GoDaddy) pointing `what-inn.tikal.in` to Railway's CNAME target.
